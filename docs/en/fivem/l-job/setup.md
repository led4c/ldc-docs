...
## Usage
::: tip USAGE
- Make sure the resource name is `l-job`.
- Insert data into the SQL job table [Jobs](#jobs).
- Insert data into the item table [Items](#items).
- Start the resource by using `ensure l-job`.
:::

## Jobs
::: tip INFO
You need to insert data into the SQL table for jobs if you want to use jobs to start work.
:::
...
## Items
::: tip INFO
Add default items to the `ox_inventory/data/items.lua` file or insert them into the database as needed.
:::
